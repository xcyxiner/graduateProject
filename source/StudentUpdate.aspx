<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="StudentUpdate.aspx.vb" Inherits="StudentUpdate" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    &gt;&gt;修改用户<br />
    学 &nbsp; &nbsp; &nbsp; 号：<asp:TextBox ID="TextBox1" runat="server" ReadOnly="True"></asp:TextBox><br />
