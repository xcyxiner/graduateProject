...
Partial Class HealthManager
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Response.Redirect("HealthUpdate.aspx?login_name=" + loginName)
    End Sub
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        For Each loginName As String In selectedUsers
            HealthLogic.Delete(loginName)
        Next
        QueryALL()
    End Sub
    Private Sub Query()
        Dim queryItems As Hashtable = New Hashtable
        queryItems.Add("Week", HealthManager.username)
    ...
    Protected Sub btnQuery_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnQuery.Click
        HealthManager.username = Me.TextBox1.Text.Trim
        Query()
        Me.TextBox1.Text = ""
    End Sub
    ...
    Protected Sub GV_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GV.PageIndexChanging
        ...
        If HealthManager.username = "" Then
            QueryALL()
        Else
            Query()
        End If
