...
Partial Class AdminManger
    ...
    Private Sub QueryALL()
        Me.TextBox1.Text = ""
        AdminManger.username = ""
        Dim dt As DataTable = UserLogic.Query
        GV.DataSource = dt
        GV.DataBind()
    End Sub
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Response.Redirect("AdminUpdate.aspx?login_name=" + loginName)
    End Sub
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        For Each loginName As String In selectedUsers
            UserLogic.Delete(loginName)
        Next
        QueryALL()
    End Sub
    Private Sub Query()
        Dim queryItems As Hashtable = New Hashtable
        queryItems.Add("UserName", AdminManger.username)
        Dim dt As DataTable = UserLogic.QueryUsers(queryItems)
        GV.DataSource = dt
        GV.DataBind()
    End Sub
    Protected Sub btnQuery_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnQuery.Click
        AdminManger.username = Me.TextBox1.Text.Trim
        Query()
        Me.TextBox1.Text = ""
    End Sub
